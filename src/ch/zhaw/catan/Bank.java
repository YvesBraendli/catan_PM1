...
/**
 * This class holds a datafield for the amount of cards, the bank
 * current has for every resource of a catan game. It has the following functions:
 * Check, if a player can make a trade with the bank and carries out a trade with the bank.
...
public class Bank {
	...
	/**
	 * Checks, if there were 4 given cards and enough cards in the bank stock.
	 * If so, returns true and deducts number of resource-cards from the bank.
	 * 
